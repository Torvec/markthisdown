...
export default function FrontmatterPreview({
  ...
  return (
    <textarea
      className="scrollbar-style w-full grow cursor-copy resize-none border-y border-l border-neutral-700 bg-neutral-800 p-4 outline-0 focus-visible:border-neutral-600 focus-visible:bg-neutral-700/50"
